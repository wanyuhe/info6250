...
* Do not use external JS other than express, cookie-parser, uuid, and the modules we've used for webpack and babel
  ...
  - Modules that do not require npm install are allowed, but make sure you aren't venturing outside of the requirements (example: using 'crypto' is a bad idea)
